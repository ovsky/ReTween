...
namespace ReTween
{
    public partial class Tween
    {
        ...
        public static TweenAction Color(SpriteRenderer renderer, Func<Color> begin, Color target, float duration = 1f, float delay = 0f, Ease ease = null)
            => Tween.Add(new TweenAction((float time) => renderer.color = UnityEngine.Color.LerpUnclamped(begin(), target, time), duration, delay, ease));
        ...
        public static TweenAction Color(Image image, Func<Color> begin, Color target, float duration = 1f, float delay = 0f, Ease ease = null)
            => Tween.Add(new TweenAction((float time) => image.color = UnityEngine.Color.LerpUnclamped(begin(), target, time), duration, delay, ease));
